...
## CHANGES LOG
v3.5.1 (2026-09-19) — кириллическая «у» + редкие RAW-форматы (из legacy v0 2025):
- session.py: кириллическая «у» как опечатка русской раскладки в names-режиме
  распознаётся как этикетка; в плане всегда пишется латинская 'y'
- raw_engine.py: RAW_EXTS расширен редкими/старыми форматами (.crw, .srf, .sr2,
  .3fr, .fff, .raw)
- tests: +2 теста (test_cyrillic_u_label_suffix, test_rare_raw_extensions),
  всего 82 passed
